...
const ReportInfo = () => {
  ...
  const [dateCloseCheckAttendance, setDateCloseCheckAttendance] = React.useState<Date>();
  ...
  const AnnoucementSchema = z
    ...
    .refine(
      (data) =>
        selectedCheckAttendance === 2 ? !(dateCloseCheckAttendance === undefined) : true,
                            ...
                            <PopoverTrigger asChild>
                              <Button
                                ...
                                className={` flex items-center text-center font-normal ${
                                  !dateCloseCheckAttendance && "text-muted-foreground"
                                } hover:bg-transparent active:bg-transparent rounded-lg shadow-none`}
                              >
                                <span
                                  className={`flex-grow text-center ${
                                ...
                                >
                                  {dateCloseCheckAttendance
                                    ? format(dateCloseCheckAttendance, "dd/MM/yyyy")
                                    : "Chọn ngày"}
                                </span>
                                <CalendarIcon className="ml-2 h-4 w-4" />
                              </Button>
